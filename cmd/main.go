...
import (
	...
	"github.com/mathianasj/virt-git-sync/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "2f233a5f.mathianasj.github.com",
	...
	if err = (&controller.VirtGitSyncReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "VirtGitSync")
		os.Exit(1)
	}
